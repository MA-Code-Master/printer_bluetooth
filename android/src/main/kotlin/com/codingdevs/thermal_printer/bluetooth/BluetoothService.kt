...
//            Log.d(TAG, " ------------- mac Address BT: $address")
    ...
    /**
     * MALY-POS FORK: returns what the write actually did.
     *
     * Upstream returned a hard-coded `true` whenever the connection *state*
     * looked right, discarding write()'s outcome entirely. That is what let a
     * dead socket report successful prints: Dart saw `true`, the retry loop
     * stood down, and the receipt was never printed and never reported.
     */
