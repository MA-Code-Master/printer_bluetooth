...
class USBPrinterAdapter private constructor() {
    ...
    fun init(reactContext: Context?) {
        ...
        // MALY-POS FORK: same Android 14+ fix as USBPrinterService.init —
        // explicit permission intent, and a receiver that states it is not
        // exported. See the comment there for why both are required.
